...
WORKDIR /src
COPY ["PortalDoFranqueadoAWSAPI.csproj", "PortalDoFranqueadoAWSAPI/"]
RUN dotnet restore "PortalDoFranqueadoAWSAPI/PortalDoFranqueadoAWSAPI.csproj"

WORKDIR "/src/PortalDoFranqueadoAWSAPI"
COPY . .
RUN dotnet build "PortalDoFranqueadoAWSAPI.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "PortalDoFranqueadoAWSAPI.csproj" \
...
Execute unit tests
```
    cd "PortalDoFranqueadoAWSAPI/test/PortalDoFranqueadoAWSAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "PortalDoFranqueadoAWSAPI/src/PortalDoFranqueadoAWSAPI"
